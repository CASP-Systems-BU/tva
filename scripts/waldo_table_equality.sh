...
then
    ...
    do
        ...
        then
            ...
            then
                mpirun --host machine-1,machine-2,machine-3 -np 3 ./${exp_name} 256 1 8192 $ROWS >> ../results/lan/${exp_name}-semi-results.txt
            elif [ ${exp_setting} = "wan" ]
            then
                mpirun --host machine-wan-1,machine-wan-2,machine-wan-3 -np 3 ./${exp_name} 256 1 8192 $ROWS >> ../results/wan/${exp_name}-semi-results.txt
            fi
